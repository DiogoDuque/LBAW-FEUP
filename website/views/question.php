<?php include_once "../templates/header.html";?>
    ...
    <div class="container">
        ...
        <div class="post row">
            <!--Score-->
            <div class="score col-md-1">
                <p class="plus1"><a href="#">+1</a></p>
                <p>3</p>
                <p class="minus1"><a href="#">-1</a></p>
            </div>
            <!--Question-->
            <div class="col-md-8">
